const wordList = [
    ...
    { word: "theater", hint: "Place for plays, movies, or performances with seats and stage." },
    { word: "cinema", hint: "Facility where films are shown to an audience; movie theater." },
    { word: "hospital", hint: "Institution providing medical treatment and nursing care for sick or injured." },
    { word: "airport", hint: "Location where aircraft regularly take off and land, serving passengers." },
    { word: "office", hint: "Room or building used for commercial, professional, or administrative work." },
    { word: "school", hint: "Institution for educating children or students." },
    { word: "restaurant", hint: "Establishment where meals are served to customers." },
    { word: "museum", hint: "Building where objects of historical, scientific, artistic, or cultural interest are exhibited." },
    { word: "park", hint: "Public green space used for recreation, relaxation, and nature." },
    { word: "beach", hint: "Sandy or pebbly shore by the ocean, popular for relaxation and recreation." },
    { word: "church", hint: "Building used for Christian religious worship and ceremonies." },
    { word: "market", hint: "Regular gathering of people for buying and selling goods." },
    { word: "factory", hint: "Building or group of buildings where goods are manufactured or assembled." },
    { word: "hotel", hint: "Establishment providing lodging, meals, and other services for travelers." },
    { word: "stadium", hint: "Large structure with seats for spectators, used for sports events and concerts." },
    { word: "bank", hint: "Institution where money is deposited, loaned, or exchanged; offers financial services." },
    { word: "zoo", hint: "Facility where live animals are exhibited to the public." },
    { word: "subway", hint: "Underground electric railway system, especially in a city." },
    { word: "camera", hint: "Device used for capturing photographs or recording videos" },
    { word: "telescope", hint: "Instrument used to view distant objects in space" },
    { word: "knife", hint: "Tool or utensil with a sharp blade, used for cutting or stabbing" },
    { word: "cooker", hint: "Appliance used for cooking food, especially rice" },
    { word: "watch", hint: "Timekeeping device worn on the wrist or carried in a pocket" },
    ...
    { word: "pen", hint: "Writing instrument with a small, narrow opening at one end for ink or similar substance" },
    { word: "mirror", hint: "Reflective surface, typically glass, used for viewing oneself or reflecting light" },
    { word: "radio", hint: "Device for receiving and transmitting signals, often used for broadcasting music and news" }
];
