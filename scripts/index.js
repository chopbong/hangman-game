...
document.addEventListener("keydown", (event) => {
  ...
  if (
    ...
    const button =
      keyboardDiv.querySelectorAll("button")[pressedLetter.charCodeAt() - 97];
...
const revealLetter = () => {
  ...
  do {
    ...
    button =
      keyboardDiv.querySelectorAll("button")[letterToReveal.charCodeAt(0) - 97];
